...
2. Research via `GET http://pipeline-api:8000/pipeline/research`
...
7. Read ArcReel skill via `GET http://arcreel:1241/skill.md`, generate video
8. Generate voiceover via `POST http://pipeline-api:8000/voiceover/generate`
9. Run quality check via `POST http://pipeline-api:8000/quality/check`
10. Ask user approval before publishing
11. Publish via `POST http://pipeline-api:8000/publish` (TikTok + Instagram Reels)
